...
class CustomPromptTemplate(BaseChatPromptTemplate):
    ...
    def insert_history(self, array):
        ...
        self.template = self.template.replace('<<history>>', chat_history)
...
tools = [tools.SearchUserDatabase(), tools.SearchAgentDatabase(), tools.AnswerUser()]
...
while True:
    ...
    current_conversation_history.append({"role": "Question", "content": chat_input})
